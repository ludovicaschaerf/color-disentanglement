...
def dci(factors, codes, continuous_factors=True, model='lasso'):
    ...
    # average all results
    print('disentanglement pre dot product to rho', disentanglement)
    print('completeness pre averaging', completeness)
    print('informativeness pre averaging', informativeness)
